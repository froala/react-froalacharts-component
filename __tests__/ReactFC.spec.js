...
jest.mock('froalacharts', () => {
  const FroalaCharts = function FroalaCharts() {};
  FroalaCharts.prototype.render = () => {};
  FroalaCharts.prototype.dispose = () => {};
  FroalaCharts.prototype.resizeTo = () => {};
  FroalaCharts.prototype.chartType = () => {};
  FroalaCharts.prototype.setChartData = () => {};
  FroalaCharts.prototype.addEventListener = () => {};
  FroalaCharts.prototype.removeEventListener = () => {};
  return FroalaCharts;
});
...
describe('ReactFC.fcRoot(core, ...modules)', () => {
  it('should resolve the FroalaCharts core with the specified modules', () => {
    const core = jest.fn();
    const m1 = jest.fn();
    const m2 = jest.fn();
